...
function MenubarSeparator(props) {
  const { className, ...rest } = props;
  return <MenubarPrimitive.Separator data-slot="menubar-separator" className={cn("bg-border -mx-1 my-1 h-px", className)} {...rest} />;
}

function MenubarShortcut(props) {
  const { className, ...rest } = props;
  return <span data-slot="menubar-shortcut" className={cn("text-muted-foreground ml-auto text-xs tracking-widest", className)} {...rest} />;
}
