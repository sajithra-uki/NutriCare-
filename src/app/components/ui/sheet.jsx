...
// Close button (can be used outside of content)
function SheetClose(props) {
  return <SheetPrimitive.Close data-slot="sheet-close" {...props} />;
}

// Portal wrapper for overlay and content
        ...
        <SheetPrimitive.Close
          className={cn(
            "absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 " +
              "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
          )}
        >
